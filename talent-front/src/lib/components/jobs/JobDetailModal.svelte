      ...
      "
				...
				<div class="flex items-center justify-between">
					<div class="flex items-center gap-3 sm:gap-4">
						<div>
							...
							<p class="mt-0.5 text-sm font-medium text-indigo-600/90">
								{job.company}
							</p>
						</div>
					</div>
			...
			>
				...
				<section class="mb-8 sm:mb-10">
					<h3 class="mb-3.5 flex items-center gap-2.5 text-lg font-semibold text-slate-800">
						About the Role
					</h3>
					<div class="prose-slate prose-sm sm:prose-base prose max-w-none">
						<p class="leading-relaxed whitespace-pre-line text-slate-600">
				...
				<section class="mb-8 sm:mb-10">
					...
					<ul class="space-y-2.5 text-[15px] text-slate-600 sm:text-base">
						{#each job.requirements || [] as req (req)}
				...
				<section class="mb-6">
					...
					<ul class="space-y-2.5 text-[15px] text-slate-600 sm:text-base">
						{#each job.benefits || [] as benefit (benefit)}
							<li class="flex items-start gap-3">
								<svg
									class="text-gray mt-0.5 h-4 w-4 shrink-0"
									viewBox="0 0 20 20"
